 ...
 *
 * <br>正如本例子开头给出的三个类，多数情况下，面向对象的思想会指导开发者对一个类扩展多个子类进行编写，但是就像面向切面编程模式被提出的原因那样，
 * 类进行扩展的过程是单向的，当我们需要对这些子类继承来的共有行为进行操作时，我们可能需要一个又一个的类分别扩展一个子类，
...
public class AspectUsage {
  ...
  public static class ClassA{
    ...
    public void showInfo(){
      System.out.println("is \"ClassA\"");
    }
    public void showInfo(String string){
      System.out.println("is \"ClassA\", info: " + string);
    }
  }

  //下面则是对ClassA的两个分别扩展的子类，思考一下，假设我们需要让ClassB和ClassA的实例具有如下效果：
  ...
  public static class ClassB extends ClassA{
    ...
    public void showInfo(){
      System.out.println("is \"ClassB\"");
    }
    public void showInfo(String string){
      System.out.println("is \"ClassB\", info: " + string);
    }
  }
  ...
  public static class ClassC extends ClassA{
    ...
    public void showInfo(){
      System.out.println("is \"ClassC\"");
    }
    public void showInfo(String string){
      System.out.println("is \"ClassC\", info: " + string);
    }
  }
  ...
  public static void main(String[] args) {
    ...
    SampleAspect.setFunction("update", (s, su, arg) -> {
      ...
      System.out.println("update called count: " + s.calculateVar("updateCounter", (int i) -> i + 1));
    });
    ...
    SampleAspect.setFunction("showInfo", fun);              // -> public void showInfo(){...}
    SampleAspect.setFunction("showInfo", fun, String.class);// -> public void showInfo(String string){...}
